...
<div class="content-body">
    <div class="row">
        <div class="col-lg-12">
            <?php if($projeCount > 0): // öğrencinin projesi varsa proje içeriği görüntülenecek ?>
                                ...
                                <div class="col-md-8">
                                    <select class="selectpicker form-control" multiple>
                                        <?php foreach($ogrenciler as $ogrenci):?>
                                              <option 
                                                  <?=
                                                      $ogrenci['proje_id'] != $proje['proje_id'] ? 
                                                      ($ogrenci['proje_id'] != null ? 'disabled' : null) : null;
                                                  ?>
                                                  value="<?=$ogrenci['ogrenci_id']?>"
                                                  <?=$ogrenci['ogrenci_id'] == getSession('id') ? 'style=display:none' : null?> 
                                                  <?=$ogrenci['proje_id'] == $proje['proje_id'] ? 'selected' : null ?>
                                              > 
            ...
            <?php else: // öğrencinin projesi yoksa uyarı panelini görecektir.?>
